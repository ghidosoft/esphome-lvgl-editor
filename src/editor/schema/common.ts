...
export const COMMON_SCHEMA: PropertySchema = [
  ...
  { key: 'x', kind: 'number', unit: 'px', inline: 'half', label: 'X' },
  { key: 'y', kind: 'number', unit: 'px', inline: 'half', label: 'Y' },
  { key: 'width', kind: 'size', inline: 'half', label: 'W' },
  { key: 'height', kind: 'size', inline: 'half', label: 'H' },
  { key: 'radius', kind: 'number', min: 0, unit: 'px', icon: 'radius' },
  { key: 'bg_color', kind: 'color' },
  { key: 'bg_opa', kind: 'number', min: 0, max: 255, slider: { min: 0, max: 255 } },
  { key: 'border_color', kind: 'color' },
  { key: 'border_width', kind: 'number', min: 0, unit: 'px', icon: 'border-width' },
  { key: 'border_opa', kind: 'number', min: 0, max: 255, slider: { min: 0, max: 255 } },
  { key: 'pad_all', kind: 'number', min: 0, unit: 'px', icon: 'pad' },
  { key: 'pad_top', kind: 'number', min: 0, unit: 'px', linkedGroup: 'padding', label: 'T' },
