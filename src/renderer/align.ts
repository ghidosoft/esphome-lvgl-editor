...
export function alignChild(
  ...
  switch (a) {
    ...
    case 'TOP_MID': x = (parent.width - child.width) / 2; y = 0; break;
    case 'TOP_RIGHT': x = parent.width - child.width; y = 0; break;
    case 'BOTTOM_LEFT': x = 0; y = parent.height - child.height; break;
    case 'BOTTOM_MID': x = (parent.width - child.width) / 2; y = parent.height - child.height; break;
    case 'BOTTOM_RIGHT': x = parent.width - child.width; y = parent.height - child.height; break;
    case 'LEFT_MID': x = 0; y = (parent.height - child.height) / 2; break;
    case 'RIGHT_MID': x = parent.width - child.width; y = (parent.height - child.height) / 2; break;
    case 'CENTER': x = (parent.width - child.width) / 2; y = (parent.height - child.height) / 2; break;
